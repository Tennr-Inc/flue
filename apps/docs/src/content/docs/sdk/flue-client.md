---
title: FlueClient
description: The Flue Agent SDK conversation client — send(), read(), wait(), abort(), approvals, history(), historyBefore(), observe(), and attachments.
...
| `toolApprovals` | Durable tool approval requests in request order, including their current decision status. Always the whole conversation's approvals, even on a bounded read.                                                                                       |
