...
/**
 * Bumped when the role/parts message projection changes shape. Revision 6:
 * serialization/transform failures and unshrinkable messages retain the
 * message envelope; synthetic output diagnostics include finish_reason.
 */
export const GEN_AI_PROJECTION_REVISION = 6;
/**
