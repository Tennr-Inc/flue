...
describe('applyHistoryWindow', () => {
	it('slices the newest messages and keeps the checkpoint, every settlement, and every approval', () => {
		...
		expect(result).toMatchObject({
			...
			// The approval targets m0, outside the window; it still ships.
			toolApprovals: [{ proposalId: 'approval_0', assistantMessageId: 'm0' }],
		});
	});
